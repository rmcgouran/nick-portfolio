...
export declare type CreateWebhooksProps = SetOptional<Except<WebhookProps, 'sys'>, 'headers'>;
export declare type UpdateWebhookProps = SetOptional<Except<WebhookProps, 'sys'>, 'headers' | 'name' | 'topics' | 'url'>;
