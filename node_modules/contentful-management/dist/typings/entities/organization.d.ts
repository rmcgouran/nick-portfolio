 ...
 * @private
 */
export declare const wrapOrganizationCollection: (makeRequest: {
    ...
    (opts: {
        ...
        action: "getMany";
    }): Promise<import("../common-types").CollectionProp<OrganizationProp>>;
    (opts: {
        entityType: "Organization";
        action: "get";
    } & {
        params: import("../common-types").GetOrganizationParams;
    }): Promise<OrganizationProp>;
    (opts: {
...
}, data: import("../common-types").CollectionProp<OrganizationProp>) => import("../common-types").Collection<Organization, OrganizationProp>;
