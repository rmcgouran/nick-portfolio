...
import { DefaultElements, ISO8601Timestamp, BasicCursorPaginationOptions, MetaLinkProps, Link, MakeRequest } from '../common-types';
/**
...
export declare function createDeleteScheduledAction(makeRequest: MakeRequest): () => Promise<ScheduledAction>;
...
export declare const wrapScheduledActionCollection: (makeRequest: {
    ...
    (opts: {
        ...
        payload: Pick<ScheduledActionProps, "environment" | "action" | "entity" | "scheduledFor">;
