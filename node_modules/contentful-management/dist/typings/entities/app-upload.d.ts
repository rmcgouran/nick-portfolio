 ...
 */
export declare const wrapAppUploadCollection: (makeRequest: {
...
}, data: import("../common-types").CollectionProp<AppUploadProps>) => import("../common-types").Collection<AppUpload, AppUploadProps>;
export {};
