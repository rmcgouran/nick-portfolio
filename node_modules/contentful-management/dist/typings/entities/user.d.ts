 ...
 */
export declare const wrapUserCollection: <T = UserProps>(makeRequest: {
    ...
    (opts: {
        ...
        params: import("../common-types").GetSpaceParams & import("../common-types").QueryParams;
    }): Promise<import("../common-types").CollectionProp<UserProps>>;
    (opts: {
        entityType: "User";
        action: "getForSpace";
    } & {
...
}, data: import("../common-types").CollectionProp<T>) => import("../common-types").Collection<T & {
    toPlainObject(): T;
}, T>;
