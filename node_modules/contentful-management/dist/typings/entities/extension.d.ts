...
export declare type CreateExtensionProps = RequireExactlyOne<SetRequired<ExtensionProps['extension'], 'name' | 'fieldTypes' | 'sidebar'>, 'src' | 'srcdoc'>;
...
export declare const wrapExtensionCollection: (makeRequest: {
    ...
    (opts: {
        ...
        payload: RequireExactlyOne<import("type-fest/source/simplify").Simplify<Pick<{
            /**
             * Extension name
             */
            name: string;
