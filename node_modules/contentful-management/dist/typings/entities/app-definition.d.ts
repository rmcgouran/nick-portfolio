 ...
 */
export declare const wrapAppDefinitionCollection: (makeRequest: {
    ...
    }): Promise<import("../common-types").CollectionProp<AppDefinitionProps>>;
    (opts: {
        entityType: "AppDefinition";
        action: "create";
    } & {
        ...
        payload: import("type-fest/source/simplify").Simplify<Pick<Pick<AppDefinitionProps, "name" | "src" | "locations" | "parameters">, "name" | "parameters"> & Partial<Pick<Pick<AppDefinitionProps, "name" | "src" | "locations" | "parameters">, "src" | "locations">>>;
    }): Promise<AppDefinitionProps>;
    (opts: {
        entityType: "AppDefinition";
        action: "update";
    ...
    (opts: {
        ...
        payload: import("type-fest").RequireExactlyOne<import("type-fest/source/simplify").Simplify<Pick<{
            name: string;
            fieldTypes: FieldType[];
            src?: string | undefined;
            srcdoc?: string | undefined;
            parameters?: {
                instance?: ParameterDefinition[] | undefined;
                installation?: ParameterDefinition[] | undefined;
            } | undefined;
            sidebar?: boolean | undefined; /**
             * Locations where the app can be installed
             */
        }, "src" | "parameters" | "srcdoc"> & Required<Pick<{
            name: string;
            fieldTypes: FieldType[];
            src?: string | undefined;
            srcdoc?: string | undefined;
             ...
             * Locations where the app can be installed
             */
        }, "name" | "fieldTypes" | "sidebar">>>, "src" | "srcdoc">;
    } & {
        headers?: Record<string, unknown> | undefined;
    }): Promise<import("./extension").ExtensionProps>;
    (opts: {
    ...
    (opts: {
        ...
        payload: Pick<import("./task").TaskProps, "body" | "assignedTo" | "status">;
    }): Promise<import("./task").TaskProps>;
    (opts: {
        entityType: "Task";
        action: "update";
...
}, data: import("../common-types").CollectionProp<AppDefinitionProps>) => import("../common-types").Collection<AppDefinition, AppDefinitionProps>;
export {};
