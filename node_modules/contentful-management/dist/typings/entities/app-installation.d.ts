 ...
 * @private
 */
export declare const wrapAppInstallationCollection: (makeRequest: {
    ...
    }): Promise<import("../common-types").CollectionProp<AppInstallationProps>>;
    (opts: {
        entityType: "AppInstallation";
        action: "upsert";
    } & {
        ...
        payload: Pick<AppInstallationProps, "parameters">;
    } & {
        headers?: Record<string, unknown> | undefined;
    }): Promise<AppInstallationProps>;
    (opts: {
...
}, data: import("../common-types").CollectionProp<AppInstallationProps>) => import("../common-types").Collection<AppInstallation, AppInstallationProps>;
