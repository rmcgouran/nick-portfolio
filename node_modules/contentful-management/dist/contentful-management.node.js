...
function createClient(params, opts = {}) {
  ...
  `${sdkMain}/${"7.19.1"}`, params.application, params.integration, params.feature);
...
function createEnvironmentApi(makeRequest) {
  ...
  return {
    ...
    createTag(id, name, visibility) {
      ...
      }).then(data => Object(_entities_tag__WEBPACK_IMPORTED_MODULE_2__["wrapTag"])(makeRequest, data));
    },
    ...
    getTags(query = {}) {
      ...
      }).then(data => Object(_entities_tag__WEBPACK_IMPORTED_MODULE_2__["wrapTagCollection"])(makeRequest, data));
    },
...
function createBulkActionApi(makeRequest) {
  ...
  return {
    ...
    waitProcessing(options) {
      ...
      return _asyncToGenerator(function* () {
        return Object(_methods_bulk_action__WEBPACK_IMPORTED_MODULE_3__["pollBulkActionStatus"])( /*#__PURE__*/_asyncToGenerator(function* () {
          return _this2.get();
        }), options);
      })();
    }
...
function wrapScheduledAction(makeRequest, data) {
  ...
  const scheduledActionWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_3__["default"])(scheduledAction, createScheduledActionApi(makeRequest));
...
class BulkActionProcessingError extends Error {
  constructor(message, bulkAction) {
    super(message);
...
class BulkActionFailedError extends BulkActionProcessingError {}
...
function _pollBulkActionStatus() {
  _pollBulkActionStatus = _asyncToGenerator(function* (getBulkActionFunction, options) {
    ...
    const throwOnFailedExecution = (_options$throwOnFaile = options === null || options === void 0 ? void 0 : options.throwOnFailedExecution) !== null && _options$throwOnFaile !== void 0 ? _options$throwOnFaile : true; // Initial delay for short-running BulkActions

    yield Object(_utils__WEBPACK_IMPORTED_MODULE_1__["sleep"])(initialDelayMs);

    while (retryCount < maxRetries && !done) {
      action = yield getBulkActionFunction(); // Terminal states
      ...
      yield Object(_utils__WEBPACK_IMPORTED_MODULE_1__["sleep"])(retryIntervalMs);
      retryCount += 1;
    }
...
function _waitForBulkActionProcessing() {
  _waitForBulkActionProcessing = _asyncToGenerator(function* ({
    plainClient,
    spaceId,
    environmentId,
    bulkActionId
  }, options) {
    return pollBulkActionStatus( /*#__PURE__*/_asyncToGenerator(function* () {
      return plainClient.bulkAction.get({
        bulkActionId,
        spaceId,
        environmentId
      });
